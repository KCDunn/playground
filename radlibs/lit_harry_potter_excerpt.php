...
<div data-role="page" id="wrapper">
	...
	<div data-role="content" class="main">
		...
		<form data-ajax="false" style="display:$formHide;" method="post" action="lit_harry_potter.php" onSubmit="return validate(this)">
		...
		<div class="content" id="output" style="display:$outputHide;">
			$output
			<a href="index.php" data-role="button" data-transition="fade">Another Lib</a>
			<a href="../index.php" data-role="button" data-transition="fade">More Games</button></a>
		</div>
