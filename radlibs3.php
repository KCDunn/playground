...
_HEAD;
    ...
    <form style="display:$formHide;" method="post" action="radlibs3.php" onSubmit="return validate(this)">
        ...
        <input type="text" name="noun" value="$noun">$fail_noun
        ...
        <input type="text" name="verb" value="$verb">$fail_verb
        ...
        <input type="text" name="adjective" value="$adjective">$fail_adj
        ...
        <input type="text" name="pronoun" value="$pronoun">$fail_pron
        ...
        <input type="text" name="adverb" value="$adverb">$fail_adv
        <label class="tooltip">Type your Name:<span class="tooltiptext">Or the name of someone you know.</span></label>
        <input type="text" name="friend" value="$friend">$fail_friend
        <br>
    ...
    <div id="output" style="display:$outputHide;">
        ...
        <p>$output</p>
        <a href="radlibs3.php"><button id="newGame">Play Again</button></a>
